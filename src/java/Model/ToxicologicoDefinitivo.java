...
@Entity
@Table(name = "toxicologico_definitivo")
@XmlRootElement

public class ToxicologicoDefinitivo extends Laudo implements Serializable {
    ...
    public ToxicologicoDefinitivo(Date dataOcorrencia) {
